      ...
      <form onSubmit={handleSubmit}>
        ...
        <S.InputWrapper>
          ...
          <input
            type="checkbox"
            name="spring"
            checked={formData.recommendedSeason.includes("spring")}
            onChange={handleChange}
          />
          <S.Label>봄</S.Label>
          <input
            type="checkbox"
            name="summer"
            checked={formData.recommendedSeason.includes("summer")}
            onChange={handleChange}
          />
          <S.Label>여름</S.Label>
          <input
            type="checkbox"
            name="fall"
            checked={formData.recommendedSeason.includes("fall")}
            onChange={handleChange}
          />
          <S.Label>가을</S.Label>
          <input
            type="checkbox"
            name="winter"
            checked={formData.recommendedSeason.includes("winter")}
            onChange={handleChange}
          />
          <S.Label>겨울</S.Label>
