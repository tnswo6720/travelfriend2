...
const TravelButton = ({
  ...
  const handleClick = (): void => {
    void router.push(destination); // 여기 수정: 버튼을 눌렀을 때 해당 'destination' 페이지로 이동
  };
...
const regions = [
  ...
  {
    name: "전라도",
    destination: "/destination/jeolla",
    bgImage:
  ...
  {
    name: "경상도",
    destination: "/destination/gyeongsang",
    bgImage:
  ...
  {
    name: "강원도",
    destination: "/destination/gangwon",
    bgImage:
